...
public class RecIntList {
	...
	public RecIntListElement getRefference(int idx) {
		return head.getRefference(idx);
	}
...
//		 kinguinSort example (1)
		...
		for (int element : array) {
			reverseExample.append(element);
		}

		reverseExample.reverse();

		System.out.println(reverseExample);
		System.out.println(reverseExample.toConnectionString());
//		System.out.println(reverseExample.get(2));
//		System.out.println("next of 3: " + reverseExample.getRefference(2).getNext());
//		System.out.println("previous of 3: " + reverseExample.getRefference(2).getPrevious());
		long finishTime = System.currentTimeMillis();

		System.out.println("time... " + (finishTime - startTime) + " milliseconds");
		System.out.println("------------------------");
...
//		System.out.println(l1.toConnectionString());
//		System.out.println(l1.getRefference(3).getNext());
//		System.out.println(l1.getRefference(3).getPrevious());
	}
}
